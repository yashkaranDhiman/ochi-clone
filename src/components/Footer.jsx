...
const Footer = () => {
  ...
  return (
    <div className='flex w-full h-screen'>
        <div className='flex flex-col justify-between p-12 w-1/2'>
            <div>
                <h2 className='uppercase text-[7vw] tracking-tight font-semibold -mb-16'>Eye-</h2>
                <h2 className='uppercase text-[7vw] tracking-tight font-semibold -mb-16'>opening</h2>
            </div>
            <div>
        ...
        <div className='flex flex-col p-10'>
            <h2 className='uppercase -tracking-[.7vw] text-[7vw]  font-semibold'>Presentations</h2>
            <div className='flex flex-col text-[#dadada]'>
                <div className='flex flex-col gap-2 mb-8'>
                    <h4 className='mb-3'>S:</h4>
                    <p className='text-[1vw] underline decoration-solid'>Instagram</p>
                    <p className='text-[1vw] underline decoration-solid'>Behance</p>
                    <p className='text-[1vw] underline decoration-solid'>Facebook</p>
                    <p className='text-[1vw] underline decoration-solid'>LinkedIn</p>
                </div>
                <div className='flex flex-col gap-2 mb-8'>
                    <h4 className='mb-3'>S:</h4>
                    <p className='text-[1vw] underline decoration-solid'>202-1965 W 4th Ave</p>
                    <p className='text-[1vw] underline decoration-solid mb-4'>Vancouver, Canada  </p>
                    <p className='text-[1vw] underline decoration-solid'>30 Chukarina St</p>
                    <p className='text-[1vw] underline decoration-solid'>Lviv, Ukraine</p>
                </div>
                <div className='flex flex-col gap-2 mb-8'>
                    <h4 className='mb-3'>E:</h4>
                    <p className='text-[1vw] underline decoration-solid'>hello@ochi.design</p>
                </div>
            </div>
            <div className='flex justify-between w-full relative text-zinc-600'>
                <h4 >© ochi design 2024. Legal Terms</h4>
